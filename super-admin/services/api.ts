/**
 * API client for the super-admin app. Same pattern as the tenant frontend:
 * attaches the JWT, auto-refreshes on 401, unwraps the { success, data } envelope.
 */
...
export const ACCESS_TOKEN_KEY = 'sa_access';
export const REFRESH_TOKEN_KEY = 'sa_refresh';
